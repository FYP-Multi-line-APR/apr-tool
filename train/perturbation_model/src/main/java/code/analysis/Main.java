...
//		/Users/sophie/Documents/SelfAPR/D4JTraining/Chart-26/source/org/jfree/data/xy/XYSeries.java
	...
	public static  void sourceReader(String path,String choice) {
		...
		System.out.println("===start print class list===");
		System.out.println(classList);
		System.out.println("===end print class list===");
		...
		System.out.println("===start print variable list===");
		System.out.println(variablesList);
		System.out.println("===end print variable list===");

		System.out.println("===start print field list===");
		System.out.println(filedList);
		System.out.println("===end print field list===");
		...
		System.out.println("===start print constructor list===");
		System.out.println(constructorList);
		System.out.println("===end print constructor list===");

		//Get method signature
		List<CtMethod> methodList = c.getElements(new TypeFilter<CtMethod>(CtMethod.class));	
		
		System.out.println("===start print method list===");
		System.out.println(methodList);
		System.out.println("===end print method list===");

		String methodInfo=MethodSignature.getMethodSignature(methodList);
		
		System.out.println("===start Method info===");
		System.out.println(methodInfo);
		System.out.println("===end Method info===");

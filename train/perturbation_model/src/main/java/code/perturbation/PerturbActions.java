...
public class PerturbActions {
	...
	private static void methodPerturb(List<CtMethod> methodList,String choice) {
		System.out.println("===start method perturbation===");
	...
	private static void processStatement(CtStatement st, int methStart, int methEnd,String choice) {
		...
		System.out.println("--start local variables--");
		System.out.println(localVariableImpl);
		System.out.println();
		...
		System.out.println("===end processing statement===");
		System.out.println();
	}
